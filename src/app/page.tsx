...
export default function Home() {
  return (
    <main>
      ...
      <section className="min-h-[90vh] flex flex-col items-center justify-center px-6 text-center relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl">
          ...
          <p className="text-lg text-zinc-600 max-w-xl mx-auto mb-10">
            You describe the idea. AI builds everything. It fixes itself while
            you sleep. You wake up to a growing business.
          </p>
      ...
      {/* ── Try It Live ── */}
      <section id="try-it" className="py-24 px-6 max-w-3xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-3xl sm:text-4xl font-bold mb-4">
            Describe your idea.
            <br />
            <span className="text-accent">Watch it come to life.</span>
          </h2>
          <p className="text-muted text-lg max-w-2xl mx-auto">
            Type any business idea below. Our intent parser extracts the
            structure — stack, market, features, tools — and shows you exactly
            what will be built. No YAML. No code. Just describe it.
          </p>
        </div>
        <InteractiveChatDemo />
      </section>

      {/* ── Static Chat Demo (preview) ── */}
      <section id="demo" className="py-24 px-6 max-w-6xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-muted text-lg max-w-2xl mx-auto">
            No YAML required. Just tell Powerhouse what you want to build — it
            extracts the intent, generates the config, and builds everything
            while you watch.
          </p>
        </div>
          ...
          <div className="flex gap-3 mb-3">
            ...
            <div className="bg-surface border border-border rounded-2xl rounded-bl-md px-5 py-3 max-w-[85%] sm:max-w-[75%]">
              ...
              <p className="text-sm text-text leading-relaxed">
                Got it. I&apos;ll set up{" "}
                <span className="text-accent">bez-spinki</span> — a Next.js
                storefront with Shopify checkout, BLIK integration, size guide
                (XL–6XL), and free shipping threshold at 200 zł. Inventory sync
                from your suppliers. Margin monitoring and A/B testing agents
                included.
              </p>
            </div>
          </div>
  ...
  autofix: true`}</pre>
              ...
              <div className="space-y-1">
                {[
                  ...
                  <div key={step.label} className="flex items-center gap-2 text-xs">
                    ...
                    <span className={step.done ? "text-muted" : "text-text"}>
                      {step.label}
                    </span>
                    {step.done && (
      ...
      <section className="py-24 px-6 max-w-6xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-3xl sm:text-4xl font-bold mb-4">
            ...
            <br />
            <span className="text-accent">Escalates to the cloud</span> when it
            matters.
          </h2>
          <p className="text-muted text-lg max-w-2xl mx-auto">
            Powered by{" "}
            <span className="text-text font-semibold">OpenJarvis</span> —
            Stanford&apos;s local-first AI framework. Simple tasks run instantly
            on your device. Complex builds scale to our agent swarm. You never
            choose — the system routes intelligently.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-12">
          ...
          <div className="bg-surface border border-border rounded-2xl p-6 sm:p-8 relative overflow-hidden">
            ...
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                <h3 className="font-semibold text-text">Local Agent</h3>
            ...
            <div className="space-y-3">
              {[
                { task: "Margin check", time: "0.3s", q: "What's my margin on Sukienki XL?" },
                { task: "Order summary", time: "0.8s", q: "Summarize today's orders" },
                { task: "Health check", time: "0.2s", q: "Is the BLIK payment gateway up?" },
              ].map(({ task, time, q }) => (
                <div
                  key={task}
                ...
                >
                  <div className="flex items-start justify-between gap-2 mb-1">
                    <span className="text-xs text-muted font-mono">{task}</span>
          ...
          <div className="bg-surface border border-border rounded-2xl p-6 sm:p-8 relative overflow-hidden">
            ...
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                <h3 className="font-semibold text-text">Agent Swarm</h3>
                <p className="text-xs text-muted">
            ...
            <div className="space-y-3">
              {[
                { task: "Full build", time: "4m 32s", q: "Build me a complete store with Shopify + BLIK" },
                { task: "Growth analysis", time: "12s", q: "Analyze traffic anomaly on /sukienki" },
                { task: "Emergency fix", time: "45s", q: "Deploy hotfix for checkout crash" },
              ].map(({ task, time, q }) => (
                <div
                  key={task}
                  className="bg-bg rounded-xl p-3 border border-border/50"
        ...
        <div className="text-center mt-8">
          <p className="text-xs text-zinc-600 max-w-lg mx-auto">
            ...
            — Stanford Hazy Research. Local-first, cloud when needed. Same
            skills catalog. Same agent standard.
          </p>
        </div>
      </section>
            ...
            {[
              {
                ...
                desc: 'One YAML file. Or just type what you want. "A plus-size fashion store for Poland with BLIK payments."',
              },
              {
                step: "2",
                title: "Agent swarm builds it",
                desc: "Architect designs. Coder implements. Reviewer validates. DevOps deploys. They loop until it's perfect.",
              },
              {
                step: "3",
                title: "It runs itself",
                desc: "Merchandising agent watches margins. Growth agent runs A/B tests. Autofix daemon patches bugs at 3am.",
              },
            ].map(({ step, title, desc }) => (
              <div
                key={step}
            ...
            <table className="w-full text-left">
              <thead>
                <tr className="border-b border-border">
                  <th className="py-3 px-4 text-muted font-medium">Capability</th>
                  <th className="py-3 px-4 text-center text-muted font-medium">Bolt</th>
                  <th className="py-3 px-4 text-center text-muted font-medium">Lovable</th>
                  <th className="py-3 px-4 text-center text-muted font-medium">v0</th>
              ...
              <tbody className="text-sm">
                {([
                  { cap: "Builds an app", powerhouse: "✅", bolt: "✅", lovable: "✅", v0: "✅" },
                  { cap: "Deploys it", powerhouse: "✅", bolt: "✅", lovable: "✅", v0: "✅" },
                  { cap: "CI/CD + monitoring", powerhouse: "✅", bolt: "❌", lovable: "❌", v0: "❌" },
                  { cap: "Self-healing", powerhouse: "✅", bolt: "❌", lovable: "❌", v0: "❌" },
                  { cap: "Agent swarms", powerhouse: "✅", bolt: "❌", lovable: "❌", v0: "⚠️" },
                  { cap: "Business agents", powerhouse: "✅", bolt: "❌", lovable: "❌", v0: "❌" },
                  { cap: "Open source", powerhouse: "✅ MIT", bolt: "❌", lovable: "❌", v0: "❌" },
                ] as const).map(({ cap, powerhouse, bolt, lovable, v0 }) => (
                  <tr key={cap} className="border-b border-border/50">
                    <td className="py-3 px-4 text-text">{cap}</td>
                    <td className="py-3 px-4 text-center text-muted">{bolt}</td>
                    <td className="py-3 px-4 text-center text-muted">{lovable}</td>
                    <td className="py-3 px-4 text-center text-muted">{v0}</td>
                    <td className="py-3 px-4 text-center text-accent font-semibold bg-accent-glow/5">
                      {powerhouse}
                    </td>
                  </tr>
                ))}
      ...
      <section className="py-24 px-6 text-center">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-xl text-muted mb-10 max-w-xl mx-auto">
            No more spending weeks on boilerplate. Describe what you want. Our
            agent swarm builds, deploys, and runs it — while you focus on what
            matters.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
      ...
      <footer className="py-12 px-6 border-t border-border text-center">
        <div className="flex flex-wrap justify-center gap-6 text-sm text-zinc-600">
          <a href="https://github.com/zd87pl/powerhouse" className="hover:text-accent transition-colors">
            GitHub
          </a>
          <a href="https://instill-api.fly.dev/docs" className="hover:text-accent transition-colors">
            API Docs
          </a>
        </div>
